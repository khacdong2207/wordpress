    ...
    <section class="section-three">
		<div class="container">
            ...
            ?>
                        <div class="col">
                            <article class="post">
                        	   <a href="<?php the_permalink(); ?>" class="post-thumbnail"><?php the_post_thumbnail( 'metro-magazine-three-row', array( 'itemprop' => 'image' ) ); ?></a>
                    ...
                    while( $single_qry->have_posts() ){
                        ...
                        <div class="col" >
                            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                <div class="image-holder">
                                    <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'metro-magazine-three-col', array( 'itemprop' => 'image' ) ); ?></a>
                                	<div class="text">
                								...
                								<a href="<?php the_permalink(); ?>" class="post-thumbnail">
                                                    <?php 
                                                        if( has_post_thumbnail() ){ 
                                                            ...
                                                            <img src="<?php echo esc_url( get_template_directory_uri(). '/images/metro-magazine-more-news.png' ); ?>" alt="<?php the_title(); ?>"/>
                                                        <?php
                                                        } 
                                                    ?>
                                                </a>
